...
if __name__ == '__main__':
    # txt_path = 'E:\CCFA\ICASSP26\main-final\predictions.txt'  # save.py 输出文件
    txt_path = r"E:\CCFA\ICASSP26\main-final\ablation_results\spatial_voxel_predictions.txt"# save.py 输出文件
